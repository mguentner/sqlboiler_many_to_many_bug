...
func (o *List) GetItems() ItemSlice {
	if o == nil {
		return nil
	}
...
var (
	listAllColumns            = []string{"id", "name"}
	listColumnsWithoutDefault = []string{"id", "name"}
	listColumnsWithDefault    = []string{}
...
func (o *List) Items(mods ...qm.QueryMod) itemQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"list_items\" on \"items\".\"id\" = \"list_items\".\"item_id\""),
		qm.Where("\"list_items\".\"list_id\"=?", o.ID),
	)
...
func (listL) LoadItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeList interface{}, mods queries.Applicator) error {
	var slice []*List
	var object *List
	...
	query := NewQuery(
		qm.Select("\"items\".\"id\", \"items\".\"name\", \"a\".\"list_id\""),
		qm.From("\"items\""),
		qm.InnerJoin("\"list_items\" as \"a\" on \"items\".\"id\" = \"a\".\"item_id\""),
	...
	for results.Next() {
		...
		if err != nil {
			return errors.Wrap(err, "failed to scan eager loaded results for items")
		}
		if err = results.Err(); err != nil {
			return errors.Wrap(err, "failed to plebian-bind eager loaded slice items")
		}
...
func (o *List) AddItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Item) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"list_items\" (\"list_id\", \"item_id\") values ($1, $2)"
...
// Sets o.R.Lists's Items accordingly.
// Replaces o.R.Items with related.
// Sets related.R.Lists's Items accordingly.
func (o *List) SetItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Item) error {
	...
	removeItemsFromListsSlice(o, related)
	if o.R != nil {
		o.R.Items = nil
	}
...
func (o *List) RemoveItems(ctx context.Context, exec boil.ContextExecutor, related ...*Item) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"list_items\" where \"list_id\" = $1 and \"item_id\" in (%s)",
...
func removeItemsFromListsSlice(o *List, related []*Item) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
