...
func (r *tagR) GetItems() ItemSlice {
	if r == nil {
		return nil
	}
...
func (o *Tag) Items(mods ...qm.QueryMod) itemQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"item_tags\" on \"items\".\"id\" = \"item_tags\".\"item_id\""),
		qm.Where("\"item_tags\".\"tag_id\"=?", o.ID),
	)
...
func (tagL) LoadItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(
		qm.Select("\"items\".\"id\", \"items\".\"name\", \"a\".\"tag_id\""),
		qm.From("\"items\""),
		qm.InnerJoin("\"item_tags\" as \"a\" on \"items\".\"id\" = \"a\".\"item_id\""),
...
func (o *Tag) AddItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Item) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"item_tags\" (\"tag_id\", \"item_id\") values ($1, $2)"
...
// Sets o.R.Tags's Items accordingly.
// Replaces o.R.Items with related.
// Sets related.R.Tags's Items accordingly.
func (o *Tag) SetItems(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Item) error {
	query := "delete from \"item_tags\" where \"tag_id\" = $1"
	...
	removeItemsFromTagsSlice(o, related)
	if o.R != nil {
		o.R.Items = nil
	}
...
// Sets related.R.Tags.
func (o *Tag) RemoveItems(ctx context.Context, exec boil.ContextExecutor, related ...*Item) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"item_tags\" where \"tag_id\" = $1 and \"item_id\" in (%s)",
...
func removeItemsFromTagsSlice(o *Tag, related []*Item) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
